    ...
    public sealed class Source_Feed_detection_Manager : IProcessing
    {
        ...
        public void Update_VoltageSources()
        {
            ...
            try
            {
                ...
                if ((FL01VT > VOLTAGLE_LIMIT_FOR_LINE_SOURCE_CHECK) && ((CB_FL01.Value == (float)DigitalStatus.Open) || CB_FL01.Qulity == (int)QualityCodes.LocalNotRenewed))
                {
                ...
                else if ((FL01VT <= VOLTAGLE_LIMIT_FOR_LINE_SOURCE_CHECK) && ((CB_FL01.Value == (float)DigitalStatus.Close) || CB_FL01.Qulity == (int)QualityCodes.LocalNotRenewed))
                {
                ...
                if ((FL02VT > VOLTAGLE_LIMIT_FOR_LINE_SOURCE_CHECK) && ((CB_FL02.Value == (float)DigitalStatus.Open) || CB_FL02.Qulity == (int)QualityCodes.LocalNotRenewed))
                {
                ...
                else if ((FL02VT <= VOLTAGLE_LIMIT_FOR_LINE_SOURCE_CHECK) && ((CB_FL02.Value == (float)DigitalStatus.Close) || CB_FL02.Qulity == (int)QualityCodes.LocalNotRenewed))
                {
