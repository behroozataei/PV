    ...
    public class Repository : IRepository
    {
        ...
        private void PopulateMeterAndAccumulatorData()
        {
            ...
            var dataTable = _staticDataManager.GetRecord(
                ...
                "ANALOG_NETWORK_PATH FROM APP_FDCIS_PARAMS");
        ...
        {
            var shiftDataTable = _staticDataManager.GetRecord("SELECT ShiftID, ShiftStartTime, ShiftEndTime, CalculationStartTime FROM APP_FDCIS_CALCTIMEPERSHIFT");
