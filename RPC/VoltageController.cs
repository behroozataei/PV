...
namespace RPC
{
    internal class VoltageController
    {
        ...
        private bool[,] OverfluxAppear = new bool[5, 9];
                                ...
                                if (!IsTransOverflux(TransActVoltage, NomTAPVoltage, _repository.GetRPCScadaPoint("VR_TAV").Value))
                                {
                                    if (OverfluxAppear[(int)Busbar, (int)Trans])
                                    {
                                        ...
                                        if (Busbar == BusbarBBName.BusbarA || Busbar == BusbarBBName.BusbarB)
                                        {
                                            ...
                                            if (MAB == 1) //MAB Open
                                            {
                                                if (Busbar == BusbarBBName.BusbarA)
                                                    if (!_updateScadaPointOnServer.WriteAnalog(_repository.GetRPCScadaPoint("MARK4"), 0))
                                                    {
                                                        result = false;
                                                        _logger.WriteEntry("Could not update value in SCADA: " + "MARK4", LogLevels.Error);
                                                    }
                                                if (Busbar == BusbarBBName.BusbarB)
                                                    if (!_updateScadaPointOnServer.WriteAnalog(_repository.GetRPCScadaPoint("MARK6"), 0))
                                                    {
                                                        result = false;
                                ...
                                else
                                {
                                    ...
                                    if (Busbar == BusbarBBName.BusbarA || Busbar == BusbarBBName.BusbarB)
                                    {
                                        if (MAB == 2) //MAB Close
                                        {
                                            ...
                                            if (!_updateScadaPointOnServer.SendAlarm(_repository.GetRPCScadaPoint("RPCSuggestion"), SinglePointStatus.Appear, "SUGGESTION: DECR TAP A/B"+", OVERFLUX appearing for the Trans" + ((int)Trans).ToString()))
                                            {
                                                _logger.WriteEntry("Sending alarm failed.", LogLevels.Info);
                                            }
                                        ...
                                        if (MAB == 1) //MAB Open
                                        {
                                            if (Busbar == BusbarBBName.BusbarA)
                                            {
                                                ...
                                                if (!_updateScadaPointOnServer.SendAlarm(_repository.GetRPCScadaPoint("RPCSuggestion"), SinglePointStatus.Appear, "SUGGESTION: DECR TAP A" + ", OVERFLUX appearing for the Trans" + ((int)Trans).ToString()))
                                                {
                                                    _logger.WriteEntry("Sending alarm failed.", LogLevels.Info);
                                                }
                                            ...
                                            if (Busbar == BusbarBBName.BusbarB)
                                            {
                                                ...
                                                if (!_updateScadaPointOnServer.SendAlarm(_repository.GetRPCScadaPoint("RPCSuggestion"), SinglePointStatus.Appear, "SUGGESTION: DECR TAP B" + ", OVERFLUX appearing for the Trans" + ((int)Trans).ToString()))
                                                {
                                                    _logger.WriteEntry("Sending alarm failed.", LogLevels.Info);
                                                }
                                    ...
                                    else
                                    {
                                        ...
                                        if (!_updateScadaPointOnServer.SendAlarm(_repository.GetRPCScadaPoint("RPCSuggestion"), SinglePointStatus.Appear, "SUGGESTION: DECR TAP PP" + ", OVERFLUX appearing for the Trans" + ((int)Trans).ToString()))
                                        {
                                            _logger.WriteEntry("Sending alarm failed.", LogLevels.Info);
                                        }
                ...
                switch (aBusbar)
                {
                        ...
                        switch (aTrans)
                        {
                            ...
                            case TransformerName.TransT5AN:
                                if ((_repository.GetRPCScadaPoint("MT5A_DS3").Value == 2) && (_repository.GetRPCScadaPoint("M51_CB").Value == 2) &&
                                    ...
                                    (_repository.GetRPCScadaPoint("GMF1_DS2").Value == 2))
                                {
                                    result = true;
                                }
                                break;
                            case TransformerName.TransT7AN:
                                if ((_repository.GetRPCScadaPoint("MT7A_DS3").Value == 2) && (_repository.GetRPCScadaPoint("MT7A_DS1").Value == 2) &&
                                    (_repository.GetRPCScadaPoint("MT7A_DS2").Value == 2) && (_repository.GetRPCScadaPoint("MT7A_DS3").Value == 2))
                                {
                                    result = true;
                                }
                                break;
                            case TransformerName.TransT8AN:
                                if ((_repository.GetRPCScadaPoint("MT8A_DS3").Value == 2) && (_repository.GetRPCScadaPoint("MT8A_CB").Value == 2) &&
                                    (_repository.GetRPCScadaPoint("MT8A_DS1").Value == 2))
                                {
                                    result = true;
                                }
                                break;
                    ...
                    case BusbarBBName.BusbarB:
                        switch (aTrans)
                        {
                            ...
                            case TransformerName.TransT5AN:
                                ...
                                break;
                            case TransformerName.TransT7AN:
                                if ((_repository.GetRPCScadaPoint("MT7A_DS3").Value == 2) && (_repository.GetRPCScadaPoint("M87_DS2").Value == 2) &&
                                    (_repository.GetRPCScadaPoint("M87_CB").Value == 2) && (_repository.GetRPCScadaPoint("M87_DS1").Value == 2) &&
                                    (_repository.GetRPCScadaPoint("ML8_DS2").Value == 2) && (_repository.GetRPCScadaPoint("ML8_CB").Value == 2) &&
                                    (_repository.GetRPCScadaPoint("ML8_DS1").Value == 2))
                                {
                                    result = true;
                                }
                                break;
                            case TransformerName.TransT8AN:
                                if ((_repository.GetRPCScadaPoint("MT8A_DS3").Value == 2) && (_repository.GetRPCScadaPoint("MT8A_CB").Value == 2) &&
                                    (_repository.GetRPCScadaPoint("MT8A_DS2").Value == 2))
                                {
                                    result = true;
                                }
                                break;
                    ...
                    case BusbarBBName.BusbarE:
                        switch (aTrans)
                        {
                            ...
                            case TransformerName.TransT4AN:
                                ...
                                break;
                            case TransformerName.TransT6AN:
                                if ((_repository.GetRPCScadaPoint("MT6A_DS3").Value == 2) && (_repository.GetRPCScadaPoint("MT6A_CB").Value == 2) &&
                                    (_repository.GetRPCScadaPoint("MT6A_DS1").Value == 2))
                                {
                                    result = true;
                                }
                                break;
                    ...
                    case BusbarBBName.BusbarF:
                        switch (aTrans)
                        {
                            ...
                            case TransformerName.TransT6AN:
                                if ((_repository.GetRPCScadaPoint("MT6A_DS3").Value == 2) && (_repository.GetRPCScadaPoint("MT6A_CB").Value == 2) &&
                                    (_repository.GetRPCScadaPoint("MT6A_DS2").Value == 2))
                                {
                                    result = true;
                                }
                                break;
            ...
            try
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (!_updateScadaPointOnServer.WriteAnalog(_repository.GetRPCScadaPoint("C1_" + ((int)aBusbar)), (float)(Counter[1, (int)aBusbar])))
                        {
                            _logger.WriteEntry("Could not update value in SCADA: " + "C1_" + aBusbar, LogLevels.Error);
                            return;
                        }
